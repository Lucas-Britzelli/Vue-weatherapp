<template>
    <div
        ...
        style="background-image: url(../src/images/BackgroundVUEProject.jpg)"
    >
                ...
                <div class="card w-96 bg-base-100 shadow-xl">
                    ...
                    <div class="card-body">
                        <template v-if="weather">
                            <template v-for="(item, key) in weather">
                                <p v-if="key === 'main'">
                                    {{ item.temp }} &#8451;
                                </p>
                                <p v-if="key === 'weather'">
    ...
    export default {
        data() {
            return {
                ...
                error: null,
                loading: true,
                citynameandcountry: 'Stockholm,Sweden'
            }
        },
